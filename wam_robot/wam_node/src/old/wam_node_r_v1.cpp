...
//=================================================================================================
    ...
    float standby[] = {-1.6247, -0.633901, -0.117314, -0.648874, -0.143198, -0.0740897, 0.105622};

    float ready[] = {-1.623, -1.037, 0, -0.6128, -0.1397, -0.003479, 0.0970};
    ...
    while(true)
    {
        ...
        {
            while(getchar() != '\n');
            float explore1[] = {-1.623, -1.237, 0, -0.6128, -0.1397, -0.003479, 0.0970};
            float explore2[] = {-1.623, -1.237, 0, -0.6128, -0.1397, -0.003479, 0.0970};
            float explore3[] = {-1.623, -1.237, 0, -0.6128, -0.1397, -0.003479, 0.0970};
            float explore4[] = {-1.623, -1.237, 0, -0.6128, -0.1397, -0.003479, 0.0970};

            std::cout << "\n\n\n\n\n~~~~~~EXPLORE MODE~~~~~~\n\n";

            std::cout << "[Enter] to move to ready position\n";
            while(getchar() != '\n');
            for (size_t i = 0; i < 7; i++)
                jp_wam[i] = ready[i];
            wam.moveTo(jp_wam);

            std::cout << "[Enter] to move to explore 1\n";
            while(getchar() != '\n');
            for (size_t i = 0; i < 7; i++)
                jp_wam[i] = explore1[i];
            wam.moveTo(jp_wam);
            ...
            std::cout << "[Enter] to move to explore 2\n";
            while(getchar() != '\n');
            for (size_t i = 0; i < 7; i++)
                jp_wam[i] = explore2[i];
            wam.moveTo(jp_wam);
            ...
            std::cout << "[Enter] to move to explore 3\n";
            while(getchar() != '\n');
            for (size_t i = 0; i < 7; i++)
                jp_wam[i] = explore3[i];
            wam.moveTo(jp_wam);
            ...
            std::cout << "[Enter] to move to explore 4\n";
            while(getchar() != '\n');
            for (size_t i = 0; i < 7; i++)
                jp_wam[i] = explore4[i];
            wam.moveTo(jp_wam);
        ...
        {
            while(getchar() != '\n');
            float dig_start[] = {-1.6247, -0.694853, -0.116721, -0.677253, -0.145017, -0.202264, 0.103772}; // 19in off ground
            float dig_end[] = {-1.623, -1.237, 0, -0.6128, -0.1397, -0.003479, 0.0970};
            s
            std::cout << "\n\n\n\n\n~~~~~~DIG MODE~~~~~~\n\n";
            ...
            for (int i=0; i<2; i++)
            {
                std::cout << "[Enter] to move to dig start\n";
                while(getchar() != '\n');
                for (size_t i = 0; i < 7; i++)
                    jp_wam[i] = dig_start[i];
                wam.moveTo(jp_wam);

                std::cout << "[Enter] to move to dig end\n";
                while(getchar() != '\n');
                for (size_t i = 0; i < 7; i++)
                    jp_wam[i] = dig_end[i];
                wam.moveTo(jp_wam);
        ...
        {
            while(getchar() != '\n');
            float retrieve[] = {-1.623, -1.237, 0, -0.6128, -0.1397, -0.003479, 0.0970};
        ...
        // If Z X or C return to standby after
        if (user_input == 'Z' || user_input == 'X' || user_input == 'C')
        {
