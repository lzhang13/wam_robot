...
template<size_t DOF>
  ...
  protected:
    ...
    ros::Subscriber bt_force_sub; //LZ
    ...
    ros::ServiceServer joint_trajectory_velocity_move_bt_srv; //LZ
  ...
  public:
    ...
    bool
    jointTrajVelMoveBt(wam_msgs::JointTrajectoryVelocityMove::Request &req, wam_msgs::JointTrajectoryVelocityMove::Response &res);
    bool 
    ...
    void
    btForceCB(const std_msgs::Float32::ConstPtr& msg);
    void 
...
template<size_t DOF>
  void WamNode<DOF>::init(ProductManager& pm)
  {
    ...
    bt_force_sub = n_.subscribe("biotac_force", 1000, &WamNode::btForceCB, this); //LZ
    ...
    joint_trajectory_velocity_move_bt_srv = n_.advertiseService("joint_trajectory_velocity_move_bt", &WamNode::jointTrajVelMoveBt, this); //LZ
...
template<size_t DOF>
  bool WamNode<DOF>::jointTrajVelMove(wam_msgs::JointTrajectoryVelocityMove::Request &req, wam_msgs::JointTrajectoryVelocityMove::Response &res)
  {
    ...
    ROS_INFO("POINTS: %d", numOfWayPoints);
    ROS_INFO("TIME: %.3f", timePerWayPoint);
    double currTimeStamp(0);
    ...
    while (trajectory.input.getValue() < spline.finalS()) 
    {
      ...
      ROS_INFO("DEBUG______: %.3f", btForce);
      
      if (btForce == 0.000 || btForce_old == btForce) 
      {
...
template<size_t DOF>
  bool WamNode<DOF>::jointTrajVelMoveBt(wam_msgs::JointTrajectoryVelocityMove::Request &req, wam_msgs::JointTrajectoryVelocityMove::Response &res)
  {
    ROS_INFO("JointTrajectoryVelocityMoveBt CALLBACK ****************");
    typedef boost::tuple<double, jp_type> jp_sample_type;
...
template<size_t DOF>
  void WamNode<DOF>::btForceCB(const std_msgs::Float32::ConstPtr& msg)
  {
    //OS_INFO("BTFORCE RECEIVED: %.3f", msg->data);
    btForce = msg->data;
  }
