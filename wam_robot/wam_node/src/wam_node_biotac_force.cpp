...
//=================================================================================================
    ...
    {
        ROS_INFO("****DEBUG_3333***************");
        jointTrajectoryPoint.positions[i] = standby[i];
        //jointTrajectory.points.positions[i] = standby[i];
        ROS_INFO("****DEBUG_4444***************");
    ...
    */
    ...
    {
        ROS_INFO("****DEBUG_3333***************");
        jointTrajectory.points[i].positions[i] = standby[i];
        //jointTrajectory.points[1].positions[i] = standby[i];
    }
    while(getchar() != '\n');
    ...
    while(true)
    {
        ...
        if (user_input == 'X')
        {
            ...
            for (size_t i = 0; i < 7; i++)
            {
                jointTrajectory.points[0].positions[i] = dig_in_a[i];
                jointTrajectory.points[1].positions[i] = dig_in_c[i];
            }
