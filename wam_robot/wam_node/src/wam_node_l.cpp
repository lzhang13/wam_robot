...
biotac::BioTacHandClass RIGHT_HAND("right_hand"); //initialize the biotac hand class    
...
template<size_t DOF>
  void WamNode<DOF>::init(ProductManager& pm)
  {
    ...
    const char* wam_jnts[] = {"right_wam/base_yaw_joint", "right_wam/shoulder_pitch_joint", "right_wam/shoulder_yaw_joint", "right_wam/elbow_pitch_joint", "right_wam/wrist_yaw_joint", "right_wam/wrist_pitch_joint", "right_wam/palm_yaw_joint"};
